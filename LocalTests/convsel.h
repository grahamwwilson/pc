...
public :
   ...
   TH1D convHist = {"convHist","Histogram ",40,-0.5,39.5};
   TH1D gconvHist = {"gconvHist","Histogram ",40,-0.5,39.5};
   TH1D duplicatesHist = {"duplicatesHist","Histogram ",40,-0.5,39.5};
   TH1D dLHist = {"dLHist","Histogram ",50,0.0,50.0};
   TH1D dRHist = {"dRHist","Histogram ",50,0.0,50.0};
   TH1D fittedPairMassHist = {"fittedPairMassHist","Histogram ",200,-0.010,0.010};
   TH1D angleEHist = {"angleEHist","Histogram ",200,0.0,2.0};
   TH1D lambdaCandidateMassHist = {"lambdaCandidateMassHist","Histogram ",200,1.0,2.0};
   TH1D photonCandidateMassHist = {"photonCandidateMassHist","Histogram ",200,0.0,1.0};
   TH1D photonCandidateMassHist2 = {"photonCandidateMassHist2","Histogram ",100,0.0,0.1};
   TH1D minDofHist = {"minDofHist", "Histogram ",100,-0.5,99.5};
   TH1D maxDofHist = {"maxDofHist", "Histogram ",100,-0.5,99.5};
   TH1D maxNormalizedChi2Hist = {"maxNormalizedChi2Hist", "Histogram ",100, 0.0, 40.0};
   TH1D xasymHist = {"xasymHist","Histogram ",100,0.0,1.0};
   TH1D asymHist = {"asymHist","Histogram ",100,-1.0,1.0};
   TH1D minpTHist = {"minpTHist","Histogram ",200,0.0,0.01};
   TH1D minpTHist2 = {"minpTHist2","Histogram ",100,0.0,0.1};
   TH1D maxpTHist = {"maxpTHist","Histogram ",100,0.0,0.1};
   TH1D dcaHist = {"dcaHist","Histogram ",1000,0.0,1.0};
