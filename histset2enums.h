...
// bookeeping enumeration: if we do this we don't need to worry about hist pointer copies and merging
       enum th1d_ids{id_ptHist, id_pzHist, id_numpcHist, id_numpvHist,id_numpvWHist,id_rerrHist, id_phierrHist, id_zerrHist,
            ...
            id_numnopcHist, id_numpvnopcHist, id_phiHist, id_mggallHist, id_pfitHist, id_zHist, id_zPVHist, id_costhetaHist,
            id_pTHist, id_EHist, id_pTHist2, id_EHist2, id_phiHist2, id_runHist, id_isdataHist, id_nPUHist, id_PUHist, id_wtHist,
            id_wwtHist, id_numpvUWHist, id_dminHist, id_dphiHist, id_mpairHist, id_dcotthetaHist, 
            id_r1dwidecutDHist, id_r1dwidecutDDHist, id_r1dwidecutNomHist, id_rnomHist,
            id_xplus0Hist, id_xplus1Hist, id_xplus2Hist, id_xplus4Hist, id_xplus8Hist, id_xplus16Hist,
            id_alpha0Hist, id_alpha1Hist, id_alpha2Hist, id_alpha4Hist, id_alpha8Hist, id_alpha16Hist,
            id_r0Hist, id_r1Hist, id_r2Hist, id_r4Hist, id_r8Hist, id_r16Hist,
            id_r1Hist2, id_r2Hist2, id_r4Hist2, id_r8Hist2,
            id_m1Hist2, id_m2Hist2, id_m4Hist2, id_m8Hist2, id_m16Hist, id_m0Hist, 
            id_minptHist, id_maxptHist,
            id_etaHist,
            id_q0Hist, id_q1Hist, id_qtotHist,
            id_zcutHist, id_zcutHist2, id_rendcapHist,
            id_conversionCandidateMassHist, id_conversionCandidateMassHist2, id_conversionCandidateMassHist3,
            id_convMassR1, id_convMassR2, id_convMassR3, id_convMassSignal, id_convMassAnomaly,
