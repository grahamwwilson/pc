void plotratio(string histtype="rhobpHist", float ymax=5000000.0, 
...
leg->AddEntry(hd,"2018 Data/MC","l");
...
if(logscale){
c1->Print((histtype+"_Ratio_Log.pdf").c_str());
}
else{
c1->Print((histtype+"_Ratio.pdf").c_str());
}
