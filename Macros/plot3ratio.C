void plot3ratio(string histtype="r1dHist2", float ymax=3000000.0, 
...
//leg->Draw();
   ...
   TLatex * tex2 = new TLatex(0.20,0.19,"2018C Data - effect of duplicate removal");
   tex2->SetNDC();
   tex2->SetTextFont(61);
...
c1->Print((histtype+"ratio.pdf").c_str());
}
